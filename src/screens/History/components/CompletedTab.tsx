...
const CompletedTab = ({}: CompletedTabProps) => {
  ...
  const status: string = "ARRIVE_AT_DROPOFF,COMPLETED";
  ...
  return (
    <>
      <FlatList
        ...
        ListEmptyComponent={
          <InfoAlert message="Chưa có chuyến đi nào được hoàn thành" />
        }
...
export default memo(CompletedTab);
