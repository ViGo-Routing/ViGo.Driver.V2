...
interface CanceledBookingDetailScreenProps {}

const CanceledBookingDetailScreen = ({}: CanceledBookingDetailScreenProps) => {
...
export default CanceledBookingDetailScreen;
